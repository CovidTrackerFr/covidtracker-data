...
df = pd.read_csv("https://www.data.gouv.fr/fr/datasets/r/19a91d64-3cd3-42fc-9943-d635491a4d76", sep=";")
...
df = data.download_and_import_table_indicateurs()


# In[25]:


df = data.import_data_tests_viros()
df = df[df["dep"]=="75"]
