...
def import_data_hosp_clage():
    ...
    df_hosp = df_hosp.groupby(["reg", "Semaine", "cl_age90"]).first().reset_index()
    df_reg_pop = pd.read_csv(PATH + 'data/france/population_grandes_regions.csv', sep=",")
...
def download_data():
    ...
    url_data_clage = "https://www.data.gouv.fr/fr/datasets/r/dc7663c7-5da9-4765-a98b-ba4bc9de9079" #"https://www.data.gouv.fr/fr/datasets/r/08c18e08-6780-452d-9b8c-ae244ad529b3" #df_metadata[df_metadata['url'].str.contains("/donnees-hospitalieres-classe-age-covid19")]["url"].values[0]
